...
<head>
    ...
    <script src="../JS/validarFormularioProfesor.js" defer></script>
    <script src="../JS/resetearAsignaturas.js" defer></script>
</head>
...
<body>
    ...
    <main>
        ...
        <form method="post" action="../funciones/añadirProfesor.php" id="formularioProfesor">           
            <div class="apartado">
                <div>
            ...
            <div class="apartado">
                ...
                <div>
                    ...
                    <input type="text" name="licencia" id="licencia" maxlength="8">
                    <p id="errorLicencia"></p>
                </div>
            </div>
